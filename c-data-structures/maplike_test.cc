...
DEFINE_MAPLIKE(IntToIntMap, int, int);
IMPL_MAPLIKE(IntToIntMap, int, int);
...
TEST_F(IntToIntMapTest, TestIntKey) {
  ...
  IntToIntMap_insert(&map, 1, sizeof(int), 11);
  IntToIntMap_insert(&map, 2, sizeof(int), 22);
  IntToIntMap_insert(&map, 3, sizeof(int), 33);
